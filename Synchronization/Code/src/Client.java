...
public class Client extends Thread { 
     ...
     */
     public void readTransactions()
     {
        ...
        try
        {
        	inputStream = new Scanner(new FileInputStream("C:\\Users\\rizwa\\OneDrive\\Desktop\\Adnan_Ali_40181614_5461_PA1\\PA2\\transaction2.txt"));
        }
     ...
     * @param
     */
    public void run() //Client run method here
    {   
        ...
        if(getClientOperation().equals("sending")) {
            ...
            if(getClientOperation().equals("receiving")) {
                ...
                System.out.println("This error is from client thread ");
            }
