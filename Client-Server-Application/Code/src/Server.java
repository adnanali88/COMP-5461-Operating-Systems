...
public class Server extends Thread {
     ...
     */  
     public void initializeAccounts()
     {
        ...
        try
        {
         inputStream = new Scanner(new FileInputStream("C:\\Users\\rizwa\\OneDrive\\Desktop\\Adnan_Ali_40181614_5461_PA1\\PA1\\src\\account.txt"));
        }
     ...
     * @param
     */
    public void run() // Implement code for run method
    {   
