 ...
 *
 * Lecture 3-1 1:21:52
 * Sending and Receiving code goes here
 * Implement TWO threads here
 *
 * Client must be concurrent using threads
 * Create 2 instances of class with threads
 * or find a way to create 2 concurrent threads
 */
...
public class Client extends Thread {
     ...
     */
     public void readTransactions()
     {
        ...
        try
        {
        	inputStream = new Scanner(new FileInputStream("C:\\Users\\rizwa\\OneDrive\\Desktop\\Adnan_Ali_40181614_5461_PA1\\PA1\\src\\transaction.txt"));
        }
     ...
     * @param
     */
    public void sendTransactions()   // ADD CODE HERE to run in thread
    {
     ...
     * @param
     */
    public void run() /* Implement the code for the run method */
    {
