 ...
 * 
 * Edited by Eric Chou (40070424) on 2021-Winter
 * 
 */
public class Philosopher extends BaseThread
{
	...
	public void eat()
	{
		try
		{
			//Eric&Adnan Edit: Philosopher start and finish talking
	...
	public void run()
	{
		for(int i = 0; i < DiningPhilosophers.DINING_STEPS; i++)
		{
			...
			//Eric&Adnan Edit: 50% of the time, the philosophers will say something
			if(Math.random() >= 0.5)
			{
				//Eric&Adnan Edit: Philosopher will start a talk-session
		        DiningPhilosophers.soMonitor.requestTalk();
		        talk();
				//Eric&Adnan Edit: Philosopher will end the talk-session
		        DiningPhilosophers.soMonitor.endTalk();
			}

			//Eric&Adnan Edit:  Fix yield() to Thread.yield();
			Thread.yield();
		}
	} // run()
